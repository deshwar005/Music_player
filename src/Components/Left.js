...
<div className="logo">
  ...
  <div className="nav">
    <div className="nav-element active">  <div className='holder'> <div className="img_sidebar space"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray"  class="bi bi-house" viewBox="0 0 16 16">
...
<div className="nav-element active">  <div className='holder'> <div className="img_sidebar space"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray"  class="bi bi-compass" viewBox="0 0 16 16">
  <path d="M8 16.016a7.5 7.5 0 0 0 1.962-14.74A1 1 0 0 0 9 0H7a1 1 0 0 0-.962 1.276A7.5 7.5 0 0 0 8 16.016zm6.5-7.5a6.5 6.5 0 1 1-13 0 6.5 6.5 0 0 1 13 0z"/>
  <path d="m6.94 7.44 4.95-2.83-2.83 4.95-4.949 2.83 2.828-4.95z"/>
</svg></div> <div className="nav-text"> <h6 >passion</h6></div> </div><div><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray"  class="bi bi-arrow-right" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"/>
</svg></div>  </div>
<div className="nav-element active">  <div className='holder'> <div className="img_sidebar space">  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray"  class="bi bi-gear-wide-connected" viewBox="0 0 16 16">
...
</svg></div> <div className="nav-text"> <h6 >gear</h6></div> </div><div><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray"  class="bi bi-arrow-right" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"/>
</svg></div>  </div>
