    ...
    return (
        ...
        <div className="component">
            ...
            <div className='playbutton'>
                ...
                {songstate && title_playing === title ? (<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="40" fill="red" className="bi bi-pause-circle-fill" viewBox="0 0 16 16"  onClick={() => {
