...
const Header = () => {
  ...
  const fetchdata = useCallback(async () => {
    try {
      const response = await axios.get(
        "https://spoticy-clone.onrender.com/allsongs"
      );
      setSongs(response.data);

      const artistrequest = await axios.get(
        "https://spoticy-clone.onrender.com/all-artist"
      );
      setArtists(artistrequest.data);
  ...
  return (
    <div className="header">
      <div className="new_header">
        ...
        <div className="name">
          {isAuthenticated ? (
            ...
            <span>
              <b onClick={() => loginWithRedirect()}>Click here to Login</b>
            </span>
          )}
        </div>
      ...
      <div className="artist_txt">Follow Artist</div>
      <div className="Boxes">
        {Artists.map((res)=>{
        ...
        return(
          <Link
          className="links"
          to={`/artist/${encodeURIComponent(res.name)}`}>
          <Artist url={res.image} name={res.name} />
        </Link>
        );
      ...
      <div className="sub">
        <div className="sub_left">
          ...
          <div className="sub_img">
            ...
            <div className="album">
              <img
                src="https://c4.wallpaperflare.com/wallpaper/98/689/83/pink-floyd-prism-album-covers-cover-art-wallpaper-preview.jpg"
                alt="none"
                width="300px"
              ></img>
            </div>
            <div className="album">
              <img
                src="https://c4.wallpaperflare.com/wallpaper/639/892/933/music-album-covers-led-zeppelin-wallpaper-preview.jpg"
                alt="none"
                width="300px"
              ></img>
            </div>
            <div className="album">
              <img
                src="https://c4.wallpaperflare.com/wallpaper/968/276/898/music-gorillaz-album-covers-wallpaper-preview.jpg"
                alt="none"
                width="300px"
              ></img>
            </div>
            <div className="album">
              <img
                src="https://c4.wallpaperflare.com/wallpaper/582/22/331/the-beatles-album-covers-sgt-peppers-lonely-hearts-club-band-entertainment-music-hd-art-wallpaper-preview.jpg"
                alt="none"
                width="300px"
              ></img>
            </div>
              ...
              return (
                <div className="album_cover">
                  ...
                  <div className="album_title">
                    <div className="album_sm">{album}</div>
                    <div className="album_lg">{title}</div>
                  </div>
